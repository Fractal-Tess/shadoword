...
export type BlinkingSquaresConfig = {
	active: boolean;
	direction: Direction;
	gridSize: number;
	squareColor: string;
...
export function createBlinkingSquaresAttachment(
	getConfig: () => BlinkingSquaresConfig
