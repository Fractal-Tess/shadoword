...
>
	<div
		class={cn(
			'absolute inset-0 -z-1 [mask-image:linear-gradient(to_right,transparent_0%,rgb(0_0_0/0.04)_20%,rgb(0_0_0/0.42)_34%,rgb(0_0_0/1)_46%)] opacity-66 [@media(max-width:860px)]:inset-x-0 [@media(max-width:860px)]:top-auto [@media(max-width:860px)]:bottom-[3.4rem] [@media(max-width:860px)]:h-24 [@media(max-width:860px)]:[mask-image:linear-gradient(to_right,transparent_0%,rgb(0_0_0/0.2)_26%,rgb(0_0_0/1)_62%)]',
		...
		<div
			class={cn(
				...
				context.app.recording &&
					'animate-[bin-drift_2.6s_linear_infinite] motion-reduce:animate-none'
			)}
		></div>
		<div
			class={cn(
				'absolute inset-0 bg-[radial-gradient(5%_62%_at_71%_96%,color-mix(in_srgb,var(--scarlet-lamp)_62%,transparent)_0%,transparent_100%),radial-gradient(4%_48%_at_88%_96%,color-mix(in_srgb,var(--scarlet)_55%,transparent)_0%,transparent_100%),radial-gradient(6%_34%_at_57%_100%,color-mix(in_srgb,var(--scarlet-lamp)_40%,transparent)_0%,transparent_100%),radial-gradient(3%_26%_at_81%_100%,color-mix(in_srgb,var(--scarlet)_34%,transparent)_0%,transparent_100%)] mix-blend-screen',
				context.app.recording &&
					'animate-[bloom-breathe_4.3s_ease-in-out_infinite] motion-reduce:animate-none'
			)}
		></div>
		<div
			class={cn(
