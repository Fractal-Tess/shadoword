...
fn bindings() -> tauri_specta::Builder<Wry> {
    tauri_specta::Builder::<Wry>::new()
        ...
        .commands(tauri_specta::collect_commands![
            commands::state::load_desktop_state,
            commands::state::get_recording_state,
            commands::state::list_input_devices,
            commands::state::poll_microphone_level,
            commands::state::stop_microphone_level_monitor,
            commands::state::load_history,
            commands::state::save_history,
            commands::state::save_desktop_settings,
            commands::state::reveal_desktop_secret,
            commands::state::copy_desktop_secret,
            commands::remote::test_remote_connection,
            commands::remote::list_openrouter_models,
            commands::remote::test_openrouter_key,
            commands::remote::list_remote_tokens,
            commands::remote::create_remote_token,
            commands::remote::revoke_remote_token,
            commands::remote::refresh_remote_overview,
            commands::remote::update_remote_runtime,
            commands::remote::select_remote_model,
            commands::remote::delete_remote_model,
            commands::remote::start_remote_download,
            commands::remote::poll_remote_download,
            commands::local::refresh_local_overview,
            commands::local::validate_local_inference_pool,
            commands::local::preload_local_model,
            commands::local::update_local_runtime,
            commands::local::select_local_model,
            commands::local::delete_local_model,
            commands::local::start_local_download,
            commands::local::poll_local_download,
            commands::recording::start_recording,
            commands::recording::cancel_recording,
            commands::recording::stop_and_transcribe,
        ])
