...
mod tests {
    ...
    #[test]
    fn plans_clipboard_and_wayland_direct_delivery() {
        assert_eq!(
            plan_output(
                true,
                PasteMethod::Direct,
            ...
            vec![
                ...
                OutputAction::Direct(OutputBackend::Wtype)
            ]
        );
    }

    #[test]
    fn plans_x11_clipboard_paste_without_permanent_copy() {
        assert_eq!(
            plan_output(
                false,
            ...
            .actions,
            vec![OutputAction::Paste(OutputBackend::Xdotool)]
        );
    }

    #[test]
    fn falls_back_to_enigo_when_session_native_tool_is_missing() {
        assert_eq!(
            plan_output(
                false,
                PasteMethod::Direct,
            ...
            .actions,
            vec![OutputAction::Direct(OutputBackend::Enigo)]
        );
    }
}
