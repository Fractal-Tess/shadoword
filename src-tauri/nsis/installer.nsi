; Custom NSIS template for Shadow Word with portable mode support.
...
Function PageLeaveInstallType
  ...
  ${If} $0 = ${BST_CHECKED}
    ...
    ; --- PORTABLE MODE --- Switch default directory to Desktop\Shadow Word for portable
...
Function .onInit
  ...
  ; or the legacy empty marker created by older Shadow Word releases. Require Data/
  ...
  ${AndIf} ${FileExists} "$INSTDIR\portable"
    ...
    FileRead $1 $2
    FileClose $1
    ${If} $2 == "Shadow Word Portable Mode"
      StrCpy $PortableMode 1
    ${OrIf} $2 == ""
...
Section Install
  ...
  ${If} $PortableMode = 1
    ...
    FileWrite $0 "Shadow Word Portable Mode"
    FileClose $0
