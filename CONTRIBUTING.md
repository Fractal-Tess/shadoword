...
1. **Search existing issues** at [github.com/cjpais/Shadow Word/issues](https://github.com/Fractal-Tess/shadoword/issues)
2. **Check discussions** at [github.com/cjpais/Shadow Word/discussions](https://github.com/Fractal-Tess/shadoword/discussions)
...
1. **Search existing discussions** at [github.com/cjpais/Shadow Word/discussions](https://github.com/Fractal-Tess/shadoword/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/Fractal-Tess/shadoword/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/Fractal-Tess/shadoword/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/Fractal-Tess/shadoword/discussions)
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/Fractal-Tess/shadoword/issues)
   - [Closed issues](https://github.com/Fractal-Tess/shadoword/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/Fractal-Tess/shadoword/pulls)
   - [Closed PRs](https://github.com/Fractal-Tess/shadoword/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/Fractal-Tess/shadoword/discussions)
...
7. **Create a Pull Request**:
   - Go to the [Shadow Word repository](https://github.com/Fractal-Tess/shadoword)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/Fractal-Tess/shadoword/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/Fractal-Tess/shadoword/discussions)
